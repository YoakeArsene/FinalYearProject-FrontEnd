...
const handleSearchSubmit = (e) => {
  ...
  if (location.pathname != "/store/browse") {
    navigate('/store/browse');
  }
}
...
const handleSelectGame = (e) => {
  if (e.target.tagName === "BUTTON") {
    return
        ...
        navigate(`/store/games/${games[e.target.parentNode.id].surname}`);
  }
}
...
const openGamePage = (e) => {
  ...
  navigate(`/store/games/${selectedGameSurname}`);
}
...
useEffect(() => {
  ...
  } else if (location.pathname === "/store/browse") {
